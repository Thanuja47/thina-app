...
export const MOCK_DEALS: Deal[] = [
  {
    ...
    description:
      '30% off any Large Triple Cheese or BBQ Chicken Pan Pizza + 1.5L Beverage at any Pizza Hut.',
    rating: 4.9,
    popular: true,
  },
  {
    ...
    description: 'Order any large hot or iced coffee and enjoy a second one completely free.',
    rating: 4.8,
    popular: true,
  },
  {
    id: 'd3',
    title: 'LKR 1,000 Off Cinema Tickets',
    ...
    dealPrice: 'LKR 1,800',
    pointsCost: 500,
    location: 'Liberty Plaza, Colombo',
    image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=600&q=80',
    expiry: 'Valid 45 Days',
    description: 'LKR 1,000 discount on 2 cinema tickets + 1 Large Salted Popcorn combo.',
    rating: 4.9,
    popular: true,
  },
  {
    id: 'd4',
    title: '15% OFF Monthly Groceries',
    ...
    description: 'Save 15% on your total bill when shopping for fresh produce and essentials.',
    rating: 4.7,
  },
  {
    id: 'd5',
    title: '25% OFF Weekend Resort Stay',
    ...
    description: 'Luxury hillside stay with complimentary breakfast for 2 adults.',
    rating: 4.95,
  },
  {
    id: 'd6',
    title: 'LKR 1,500 Fashion Voucher',
    ...
    expiry: 'Valid 30 Days',
    description: 'Redeem LKR 1,500 instant discount on apparel, footwear, and accessories.',
    rating: 4.6,
  },
];
...
export const MOCK_MOVIES: Movie[] = [
  {
    ...
    description: 'An epic tale of courage and devotion set in ancient Ceylon.',
  ...
  },
  {
    ...
    description: 'A mind-bending journey across parallel dimensions linked to ancient folklore.',
    badge: 'Trending #1',
  },
  {
    id: 'm3',
    ...
    description: 'A heartwarming rivalry turned into an unbreakable bond.',
  ...
  },
  {
    ...
    duration: '2h 10m',
    rating: '8.7',
    poster: 'https://images.unsplash.com/photo-1518173946687-a4c8a383392e?w=400&q=80',
    director: 'Priyantha Fernando',
    description: 'A romantic musical journey through the misty hills of Nuwara Eliya.',
    badge: 'Blockbuster',
  },
  {
    id: 'm5',
    ...
    duration: '1h 48m',
    rating: '8.2',
    poster: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400&q=80',
    director: 'Asoka Handagama',
    description: 'A poetic exploration of memory and loss in rural Sri Lanka.',
  },
  {
    id: 'm6',
    title: 'Mahagedara',
    ...
    description: 'A gripping family saga set against a backdrop of political intrigue.',
    badge: 'Award Winner',
  },
];
